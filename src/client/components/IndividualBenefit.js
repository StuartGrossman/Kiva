  ...
  render() {
    return (
      <div className="row Benefit-Dimensions" style={{ backgroundColor: this.props.color }}>
        ...
        <div className="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12 Margin-Auto ">
        ...
        {/* <div className="col-xl-1 col-lg- col-md-7 col-sm-12 col-12 Margin-Auto"> */}

        <div className="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 Margin-Auto">
