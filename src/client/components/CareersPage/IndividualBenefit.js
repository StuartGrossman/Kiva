  ...
  render() {
    return (
      <div className="row Benefit-Dimensions " style={{ backgroundColor: this.props.color }}>
        <div className="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-4 Margin-Auto Iphone-Margin-Top">
        ...
        <div className={(this.props.customClass ? 'Grow-Your-Mind Benefit-Title col-xl-2 col-lg-2 col-md-2 col-sm-8 col-8  Margin-Auto ' : 'col-xl-2 col-lg-2 col-md-2 col-sm-8 col-8 Margin-Auto Iphone-Margin-Title-Top ')}>
