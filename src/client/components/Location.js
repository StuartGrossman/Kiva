            ...
            >
              ...
              <div>
                <p className="We-hire">
                  ...
                  be. That means some of our employees work remotely from home,
                  and others work in our offices around the world. We currently
                  have offices in: San Francisco, Portland, San Jose, Chicago,
                  New York, Nairobi (Kenya), and Bangkok (Thailand).
                </p>
                <p className="We-hire">
            ...
            <div className="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10 ">
              <div>
                <p className="Footer-Text">
                  ...
                  our global borrowers. We focus on reducing bias in all of our
                  people practices and policies including hiring, global pay
                  equity, development and resources.
                </p>
              </div>
            </div>
            <div className="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1 " />
